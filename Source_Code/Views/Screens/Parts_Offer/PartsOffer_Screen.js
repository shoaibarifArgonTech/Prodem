...
export default function PartsOffer_Screen() {
  ...
  function partOffer_ApiCaller(imageLink) {
    if (CarPart == "" || PartCode == "") {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.code == "200") {
          initializeData();
          setisLoading(false);
          helper.showTextToast("Requested Successfully.", Colors.theme);
          // helper.showTextToast(response.data.message, Colors.theme)
  ...
  function galleryImageController() {
    ...
    ImagePicker.openPicker({
      ...
      // partOffer_ApiCaller(`data:${image.mime};base64,${image.data}`)
    });
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text_Statement Statement={"Car Part"} />
          <TextInputs
          ...
          <Text_Statement Statement={"Other details"} />
          <TextInputs
            Keyboardtype={"default"}
            AutoCapital={"none"}
            PlaceHolder={""}
          ...
          <Text_Statement Statement={"Vehicle"} />
          <View
            style={{
              flexDirection: "row",
              alignItems: "center",
