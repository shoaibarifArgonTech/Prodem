        ...
        apiHandler.sendSecurePostRequest(
            ...
            (resp) => {
                ...
                if (resp.data?.verification_code == Otp) {
                    ...
                    // helper.showTextToast(resp.message, Colors.theme)
                    helper.showTextToast("your four digit code is not matched!", Colors.theme)
                    setisLoading(false)
                }
            },
            (error) => {
        ...
        apiHandler.sendSecurePostRequest(
            ...
            (resp) => {
                ...
                if (resp.status == "success") {
                    helper.showTextToast("Again four digit code has sent to your email.", Colors.theme)
            ...
            <View
                ...
                {isLoading ?
                    ...
                    <View style={{
                        ...
                        <Simple_Button
                            OnAction={() => { Verification_Controller() }}
                            Width={wp(90)}
                            Height={hp(6)}
                            BtnTitle={"Verify"}
                        />
